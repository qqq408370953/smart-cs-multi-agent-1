...
> **Node.js 代码证据：**面试回答不要只背结论。可通过[Node.js Agent 全流程详细讲解](../node-agent-detailed-guide.md)定位 Supervisor 条件边、RAG 降级、合规两阶段、三类记忆与 Checkpoint 的真实实现，并明确哪些是当前能力、哪些是生产化规划。
